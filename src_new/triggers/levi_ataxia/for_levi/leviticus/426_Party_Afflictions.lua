...
if isTargeted(matches[3]) then
	paAff(matches[4])
  tarAffed(matches[4])
  if applyAffV3 then applyAffV3(matches[4]) end
...
elseif isTargeted(matches[4]) then
  ...
  tarAffed(matches[5])
  if applyAffV3 then applyAffV3(matches[5]) end
...
if applyAffV3 then applyAffV3(matches[5]) end
tarAffed(matches[6])
if applyAffV3 then applyAffV3(matches[6]) end
tarAffed(matches[7])
if applyAffV3 then applyAffV3(matches[7]) end
confirmAffV2(matches[4])
confirmAffV2(matches[5])
