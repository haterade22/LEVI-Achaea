...
patterns:
- pattern: You open your eyes once more, and the world about you is darkness.
  type: 3
]]--

-- BLINDNESS TRANCE LANDED. Live-captured 2026-09-17. This is the game's word that the in-flight
...
--
-- Deliberately does NOT write `ataxia.defences.blindness`. The landing is proof the ACTION
...
if ataxia_senseLanded then ataxia_senseLanded("blindness") end
