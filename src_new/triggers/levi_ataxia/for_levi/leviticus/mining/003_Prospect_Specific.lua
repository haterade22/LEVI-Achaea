...
send("clt8 Started prospect for - " ..matches[2].. " - at "..gmcp.Room.Info.name.." in "..gmcp.Room.Info.area)
send("clan mmc tell Started prospectv2 for " .. matches[1] .. " at " .. gmcp.Room.Info.name .. " in " .. gmcp.Room.Info.area)
