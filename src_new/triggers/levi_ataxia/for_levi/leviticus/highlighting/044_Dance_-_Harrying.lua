...
patterns:
- pattern: ^Spiral steps bleed into a perfect staccato as for the briefest moment you transition into the deadly harrying\.$
  type: 1
]]--

-- BLADEDANCE FIRE LINE (HARRYING). User, 2026-08-06: highlight and echo these.
--
...
if ataxia and ataxia.defences then
  ataxia.defences.hawkstep = nil
  ataxia.defences.harrying = true
...
deselect()
resetFormat()
ataxiaEcho("<medium_purple>HARRYING<reset> -- dancing.")
