...
patterns:
- pattern: ^Spiral steps bleed into a perfect staccato as for the briefest moment you move as the crashing waves\.$
  type: 1
]]--

-- BLADEDANCE FIRE LINE (WAVE DANCE). User, 2026-08-06: highlight and echo these.
--
...
if ataxia and ataxia.defences then
  ...
  ataxia.defences.wavedance = true
end
...
deselect()
resetFormat()
ataxiaEcho("<light_sea_green>WAVE DANCE<reset> -- dancing.")
