...
patterns:
- pattern: You are already deaf.
  type: 3
]]--

-- DEAF REFUSED -- already up. Live-captured 2026-09-17 (both refusals pasted by the user, so
...
-- `ataxia.defences.deafness` -- see the note on ataxia_senseRefused in
...
if ataxia_senseRefused then ataxia_senseRefused("deafness") end
