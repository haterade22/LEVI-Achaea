...
patterns:
- pattern: You lightly caress a button on a paradox puzzle pentagon and suddenly a hazy image of
  type: 2
- pattern: ^You lightly caress a button on a paradox puzzle pentagon and suddenly a hazy image of (.+) \(room \#\d+\) flashes
