...
| 102 | Psiwave | `^Psiwave\s+\d+\s+\w+` | sets `psionPsiwave` (in the tower only) -- `psi radiate` replaces `psi shatter` as the Psion's equilibrium attack, paid and free (v4.7.355) | none |
