...
-- Focused on: Rain prep â†’ Gaital kill â†’ DISPATCH
...
-- Form transition paths (from â†’ available destinations)
shikudo.transitions = {
  Tykonos = {"Willow"},
  Willow = {"Rain"},
  Rain = {"Tykonos", "Oak"},
...
-- Flow: Willow â†’ Rain â†’ Oak â†’ Gaital (when ready)
...
function shikudo.shouldTransition()
  ...
  if form == "Gaital" then
    ...
    if legsPrepped and headPrepped then
      ...
      if kata >= 9 then
        return "Maelstrom"  -- Maelstrom â†’ Oak â†’ back to Gaital
      end
    ...
    if kata >= 9 then
      return "Maelstrom"  -- Maelstrom â†’ Oak to continue prep
    end
    return nil
  end

  -- â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?
  -- PRIORITY 0: ALL LIMBS READY â†’ Go to Gaital for kill
  -- Only go to Gaital when BOTH legs AND head are prepped
  -- â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?
  if legsPrepped and headPrepped then
  ...
  if form == "Oak" then
    if kata >= 9 then
      ...
      -- PRIORITY 1: All limbs prepped â†’ Gaital for kill
      if legsPrepped and headPrepped then
        return "Gaital"
      end

      -- PRIORITY 2: Both legs PREPPED â†’ Gaital (can finish head with needle)
      -- Don't waste time cycling to Willow when legs are already done!
      if legsPrepped then
        return "Gaital"  -- Gaital has needle to prep head
      end

      -- PRIORITY 3: Both legs close + head close â†’ Gaital
      local ll = shikudo.getLimbDamage("left leg")
      local rl = shikudo.getLimbDamage("right leg")
      local h = shikudo.getLimbDamage("head")
...
function shikudo.selectKick()
  ...
  elseif form == "Oak" then
    ...
    -- This prevents: nervestrikeâ†’prep, then risingkickâ†’break
...
function shikudo.selectRainStaff(slot, parried)
  ...
  if slot == 1 then
    ...
    elseif headHits >= 1 and parried ~= "head" then
      ...
      -- All prepped â†’ afflictions (use LIGHT to avoid accidental damage)
      ataxiaTemp.slot1Target = "torso"
...
function shikudo.selectGaitalStaff(slot, parried)
  ...
  -- PHASE 0: Not prone and limbs need prep â†’ prep first, don't sweep yet
  ...
  -- PHASE 1: Not prone + ALL limbs prepped â†’ SWEEP to prone them
  ...
  -- PHASE 2: Prone + BOTH legs ready â†’ needle for head + windpipe
  ...
  -- PHASE 2b: Prone but one/both legs need work â†’ kuro to prep
...
function shikudo.status()
  ...
  cecho("\n<cyan>â• â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•£")
  cecho("\n<cyan>â•‘ <white>Target: <yellow>" .. tostring(target or "None") .. (isMounted and " <red>[MOUNTED]" or "") .. "<cyan>")
  cecho("\n<cyan>â•‘ <white>Form: <green>" .. form .. " <grey>(" .. kata .. "/" .. maxKata .. " kata)<cyan>")
  cecho("\n<cyan>â•‘ <white>Hyperfocus: " .. (hyperfocus == "head" and "<green>HEAD" or "<yellow>" .. hyperfocus) .. "<cyan>")
  cecho("\n<cyan>â• â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•£")
  cecho("\n<cyan>â•‘ <white>DYNAMIC THRESHOLDS (1 hit from break):<cyan>")
  cecho("\n<cyan>â•‘   <white>Leg Prep: <yellow>" .. string.format("%.1f%%", legThreshold) .. "<cyan>")
  cecho("\n<cyan>â•‘   <white>Head Prep: <yellow>" .. string.format("%.1f%%", headThreshold) .. "<cyan>")
  cecho("\n<cyan>â• â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•£")
  cecho("\n<cyan>â•‘ <white>LIMB DAMAGE:<cyan>")
  cecho("\n<cyan>â•‘   <white>Head: " .. (headPrepped and "<green>" or "<red>") .. string.format("%.1f%%", shikudo.getLimbDamage("head")) .. (headPrepped and " PREPPED" or ""))
  ...
  cecho("\n<cyan>â•‘   <white>L Leg: " .. (leftPrepped and "<green>" or "<red>") .. string.format("%.1f%%", shikudo.getLimbDamage("left leg")) .. (leftPrepped and " PREPPED" or "") .. leftArrow)
  cecho("\n<cyan>â•‘   <white>R Leg: " .. (rightPrepped and "<green>" or "<red>") .. string.format("%.1f%%", shikudo.getLimbDamage("right leg")) .. (rightPrepped and " PREPPED" or "") .. rightArrow)
  cecho("\n<cyan>â• â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•£")
  cecho("\n<cyan>â•‘ <white>KILL CONDITIONS:<cyan>")
  ...
  cecho("\n<cyan>â• â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•£")
  cecho("\n<cyan>â•‘ <white>PREP STATUS:<cyan>")
  cecho("\n<cyan>â•‘   <white>Focus Leg: <yellow>" .. focusLeg:upper() .. " <grey>(lower damage, hit first)")
  cecho("\n<cyan>â•‘   <white>Both Legs Prepped: " .. (bothLegsPrepped and "<green>YES" or "<yellow>NO"))
  cecho("\n<cyan>â•‘   <white>Head Prepped: " .. (headPrepped and "<green>YES" or "<yellow>NO"))
  cecho("\n<cyan>â•‘   <white>Ready for Gaital: " .. ((bothLegsPrepped and headPrepped) and "<green>YES" or "<yellow>NO"))
  cecho("\n<cyan>â•šâ•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?â•?\n")
end
