-- unnamed > For Levi > Levi_062424 > mudlet-mapper_24 > Mudlet Mapper > Game-specific > Ashyria > mmp.registerAshyriaEnvData

function mmp.registerAshyriaEnvData(_, game)
