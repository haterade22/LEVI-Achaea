-- unnamed > For Levi > Levi_062424 > mudlet-mapper_24 > Mudlet Mapper > Game-specific > Aetolia > mmp.registerAetoliasEnvData

function mmp.registerAetoliasEnvData(_, game)
